	...
	<div class="ier-premium-upgrade wt-ierpro-sidebar">
		...
		<div class="ier_pro_plugins_section_small">
				...
				<div class="ier-premium-upgrade wt-ierpro-sidebar">
					<div class="wt-ierpro-header" style="width:95%">
						<div class="wt-ierpro-name">
							<div style="float: left"><img src="<?php echo WT_P_IEW_PLUGIN_URL; ?>assets/images/gopro/order-ie.svg" alt="featured img" width="36" height="36"></div>
							...
							<div style="position: absolute;top: -21px;right: -24px;z-index: 1000;"><img src="<?php echo WT_P_IEW_PLUGIN_URL; ?>assets/images/gopro/crown.svg" alt="featured img" width="36" height="36"></div>
			...
			<div class="wt-import-export-upsell-small-wrapper market-box table-box-main wt-ier-advt-product wt-ier-advt-product_categories wt-ier-advt-product_review wt-ier-advt-product_tags">
				<div class="ier-premium-upgrade wt-ierpro-sidebar">
					<div class="wt-ierpro-header" style="width:95%">
						<div class="wt-ierpro-name">
							<div style="float: left"><img src="<?php echo WT_P_IEW_PLUGIN_URL; ?>assets/images/gopro/product-ie.svg" alt="featured img" width="36" height="36"></div>
		...
		<div class="wt-ierpro-header">
			<div class="wt-ierpro-name-suite">
				...
				<div style="position: absolute;top: -28px;right: -24px;z-index: 1000;"><img src="<?php echo WT_P_IEW_PLUGIN_URL; ?>assets/images/gopro/crown.svg" alt="featured img" width="36" height="36"></div>
